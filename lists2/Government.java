/** 
    Exercise 2.2.2 Delete the word static as few times as possible 
    so that this program compiles.
    Make sure to read the comments before doing the exercise.
...
public class Government {
	...
	public class King {
		public void doStuff() {
			spend();
			// call spend method 
			// which belong to Class Government.			
		}
	}
